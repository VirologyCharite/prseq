...
class FastaReader:
    ...
    Example:
        ...
        ...     reader = FastaReader(file=f)  # Read from file object
    ...
    def __init__(
        ...
        """
        self._reader = _prseq.FastaReader(path=path, file=file, sequence_size_hint=sequence_size_hint)
    ...
    @classmethod
    def from_file_object(cls, file: object, sequence_size_hint: int | None = None) -> 'FastaReader':
